...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Мар 07 2016 г., 15:22
...
CREATE TABLE IF NOT EXISTS `dossier` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `name` char(80) COLLATE utf8_unicode_ci NOT NULL,
  `andername` char(80) COLLATE utf8_unicode_ci NOT NULL,
  `surname` char(80) COLLATE utf8_unicode_ci NOT NULL,
  `phone` char(40) COLLATE utf8_unicode_ci NOT NULL,
  `sity` char(80) COLLATE utf8_unicode_ci NOT NULL,
  `land` char(40) COLLATE utf8_unicode_ci NOT NULL,
  `email` char(80) COLLATE utf8_unicode_ci NOT NULL,
  `img` char(120) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `dossier` (`id`, `name`, `andername`, `surname`, `phone`, `sity`, `land`, `email`, `img`) VALUES
(1, 'Сергей', 'Александрович', 'Листопадов', '1010101', 'Минск', 'Беларусь', 'list@gmail.com', 'PhotoTest.png'),
(2, 'Алла', 'Сергеевна', 'Сусик', '987654321', 'Бельцы', 'Молдова', 'alla@gmail.com', NULL),
(3, 'Борис', 'Борисович', 'Борисов', '22620', 'Минск', 'Беларусь', 'boris@gmail.com', NULL);
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `dossier_id` int(11) unsigned DEFAULT NULL,
  `block` tinyint(1) NOT NULL DEFAULT '0',
  `status` char(40) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `index_foreignkey_user_dossier` (`dossier_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=4 ;
...
INSERT INTO `user` (`id`, `login`, `password`, `dossier_id`, `block`, `status`) VALUES
(1, 'admin', 12345, 1, 0, 'admin'),
(2, 'alla', 12345, 2, 0, 'teacher'),
(3, 'boris', 12345, 3, 0, 'student');
...
--
ALTER TABLE `user`
  ADD CONSTRAINT `c_fk_user_dossier_id` FOREIGN KEY (`dossier_id`) REFERENCES `dossier` (`id`) ON DELETE SET NULL ON UPDATE SET NULL;
