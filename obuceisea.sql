...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Мар 08 2016 г., 22:00
...
(1, 'Василий', 'Васильевич', 'Василевский', 'vasea@mail.ru', 'Беларусь', 'Минск', 2222222, NULL, NULL),
...
CREATE TABLE IF NOT EXISTS `test1` (
  ...
  PRIMARY KEY (`id`),
  KEY `index_foreignkey_test1_test2` (`test2_id`)
...
INSERT INTO `test1` (`id`, `test2_id`, `name`) VALUES
(1, 1, 'new n'),
(2, 2, 'zxcv');
...
CREATE TABLE IF NOT EXISTS `test2` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `comp` varchar(123) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `test2` (`id`, `comp`, `data`) VALUES
(1, 'new d', 1),
(2, 'asdfg', 2);
...
INSERT INTO `user` (`id`, `dossier_id`, `login`, `password`, `status`, `about`, `block`) VALUES
(1, 0, 'admin', '123', 'admin', NULL, 0),
(2, 1, 'vasea', '12345', 'student', NULL, 0),
(3, 2, 'alla', '12345', 'teacher', 'Александр Сергеевич Пушкин родился 26 мая 1799 года в Москве в дворянской помещичьей семье (отец его был майор в отставке) в день праздника Вознесения.\nВ тот же день у императора Павла родилась внучка, в честь которой во всех церквах шли молебны и гудели колокола. Так, по случайному совпадению день рождения русского гения был ознаменован всеобщим народным ликованием. Символично и место рождения поэта г. Москва - самое сердце русской жизни, России.\nБудущего поэта крестили 8 июня в церкви Богоявления в Елохове.\nОтец Пушкина Сергей Львович и мать Надежда Осиповна, урожденная Ганнибал, были дальними родственниками. Пылкие страсти, руководившие предками как по отцовской, так и по материнской линии, оказали свое влияние и на Пушкина.\nСемья (кроме Александра, были еще дети Ольга и Лев) принадлежала к самой образованной части московского общества.', 0);
...
--
ALTER TABLE `test1`
  ADD CONSTRAINT `c_fk_test1_test2_id` FOREIGN KEY (`test2_id`) REFERENCES `test2` (`id`) ON DELETE SET NULL ON UPDATE SET NULL;
