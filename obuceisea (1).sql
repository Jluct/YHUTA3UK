...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Мар 20 2016 г., 21:04
...
(1, 'Василий', 'Васильевич', 'Василевский', 'vasea@mail.ru', 'Беларусь', 'Минск', 2222222, 'смсмс', '&lt;b&gt;Привет мир!&lt;/b&gt;'),
...
(2, 1, 1, 'Табличная вёрстка', NULL, '<p>Табличная вёрстка описание дополненное+</p>\r\n', 1),
(3, 1, 2, 'Блочная вёрстка', NULL, 'Блочная вёрстка описание', 1),
(5, 2, 1, 'Алгоритмизация', NULL, '<p>Алгоритмизация описание++</p>\r\n', 1),
(6, 2, 1, 'DOM', NULL, 'DOM описание', 1),
(7, 1, 3, 'Адаптивная вёрстка', NULL, 'Адаптивная вёрстка описание', 1),
(8, 33, 1, 'Курс тест', NULL, 'рапрапрапрап', 1),
(9, 1, 4, 'Препроцессоры', NULL, 'Lorem ipsum и так далее', 1),
(10, 1, 6, 'ывкцуе', NULL, 'папвапвап', 1),
(11, 12, 1, 'Lorem', NULL, 'Lorem Inpsum', 1);
...
(1, 'Вёрстка', 8, 'Ergo, draco maledicte et omnis legio diabolica, adjuramus te per Deum + vivum, per Deum + verum, per Deum + sanctum, per Deum qui sic dilexit mundum, ut Filium suum unigenitum daret, ut omnes qui credit in eum non pereat, sed habeat vitam aeternam: cessa decipere humanas creaturas, eisque aeternae perditionis venenum propinare: desine Ecclesiae nocere, et ejus libertati laqueos injicere.', 'Lorem Ipsum - это текст-"рыба", часто используемый в печати и вэб-дизайне. Lorem Ipsum является стандартной "рыбой" для текстов на латинице с начала XVI века. В то время некий безымянный печатник создал большую коллекцию размеров и форм шрифтов, используя Lorem Ipsum для распечатки образцов. Lorem Ipsum не только успешно пережил без заметных изменений пять веков, но и перешагнул в электронный дизайн. Его популяризации в новое время послужили публикация листов Letraset с образцами Lorem Ipsum в 6', 1),
(2, 'JS для начинающих', 4, '<p>Vivamus vestibulum auctor velit, quis interdum lectus tempor et. Ut diam nibh, faucibus vitae pellentesque vitae, vulputate quis justo. Phasellus lobortis gravida nunc eu gravida. Fusce maximus est nec nibh aliquam, eu elementum arcu convallis. Pellentesque congue orci ut mollis congue. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum sed justo a nibh vestibulum accumsan.</p>\r\n', 'Non Non ultra audeas, serpens callidissime, decipere humanum genus, Dei Ecclesiam persequi, ac Dei electos excutere et cribrare sicut triticum + . Imperat tibi Deus altissimus + , cui in magna tua superbia te similem haberi adhuc praesumis; qui omnes homines vult salvos fieri et ad agnitionem veritaris venire.', 1),
...
(1, 'Таблицы', 'Таблицы описание\r\n', '<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus suscipit volutpat vestibulum. Cras ut quam molestie ex facilisis iaculis in ac mi. Quisque volutpat facilisis urna, ac dignissim purus volutpat ut. Mauris felis odio, placerat vel vestibulum sit amet, auctor sed tortor.</p>\r\n\r\n<p>Aenean egestas tempus orci nec fringilla. Nulla consectetur porttitor accumsan. Mauris gravida vitae massa in dignissim. Nullam in volutpat enim. Curabitur hendrerit euismod vulputate. Cras sed vehicula enim. Mauris nisl enim, pulvinar et feugiat et, lacinia sed dui. Duis cursus rutrum erat. Fusce nec odio eu sem tempus tincidunt aliquam vitae mauris.</p>\r\n', 1, 1, 2, 0),
(2, 'Вёрстка таблиц', '<p>Вёрстка таблиц описание+++</p>\r\n', 'Suspendisse potenti. Sed mollis dolor neque, viverra cursus mi gravida eget. Nulla a finibus mauris. Integer nec elit eros. Pellentesque at libero leo. Nam est urna, rhoncus quis venenatis ac, volutpat nec turpis. Cras egestas diam sed mauris pharetra, nec volutpat velit iaculis. Aenean efficitur vitae sapien at aliquet. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut varius sapien eget finibus dignissim. Quisque fringilla porttitor volutpat.', 2, 1, 2, 0),
(3, 'Блоки', 'Блоки описание', 'Блоки описание', 1, 1, 3, 0),
(4, 'Вёрстка блоков', 'Вёрстка блоков описание', 'Вёрстка блоков описание', 2, 1, 3, 0),
(5, 'Понятие алгоритм', '<p>Понятие алгоритм описание+</p>\r\n', 'Sed accumsan est sodales risus placerat efficitur. Nam fermentum non eros non ornare. Nulla in rutrum erat. Donec commodo facilisis sapien, aliquet ullamcorper quam dapibus sit amet. Etiam faucibus purus non nibh venenatis tempus. Aliquam efficitur lacus quis eros finibus, fringilla accumsan orci facilisis. Etiam vehicula luctus arcu, quis mollis augue dictum ut. Etiam scelerisque auctor erat et efficitur. Aliquam eget augue nec nibh laoreet pretium.', 1, 1, 5, 0),
(6, 'Цикл как элемент алгоритма', 'Цикл как элемент алгоритма описание', 'Цикл как элемент алгоритма описание', 2, 1, 5, 0),
(7, 'Построение веб-страницы', 'Построение веб-страницы описание', '<p>Построение веб-страницы описание+++++</p>\r\n', 1, 1, 6, 0),
(8, 'DOM и его особенности', 'DOM и его особенности описание', 'DOM и его особенности описание', 2, 1, 6, 0),
(9, 'Лекция 1', 'Лекция 1 описание\r\n', '<p>Nullam tempor nunc bibendum, tempor tortor sit amet, suscipit felis.</p>\r\n\r\n<p>Nunc ac libero non nunc varius venenatis. Vivamus dapibus risus interdum, ultrices erat vitae, luctus elit. Aenean mollis sollicitudin urna. Proin nec arcu at velit scelerisque tempor. Etiam volutpat turpis vitae tristique eleifend. Pellentesque convallis eleifend nibh, non aliquam neque ultricies ac. Vivamus interdum tempor sodales. Morbi at elementum leo. Quisque rhoncus sed odio at porttitor.</p>\r\n', 1, 1, NULL, 22),
