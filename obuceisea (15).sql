...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Мар 16 2016 г., 20:18
...
(7, 1, 3, 'Адаптивная вёрстка', 1, 'Адаптивная вёрстка описание', 1),
...
(23, 8, 'Редактировать', '?ctrl=teacher&action=AddModul&id=', 0, 1),
(24, 8, 'Блокировать', '?ctrl=teacher&action=AddModul&id=', 0, 1),
(25, 8, 'Удалить', '?ctrl=teacher&action=AddModul&id=', 0, 1);
...
INSERT INTO `progress` (`id`, `information_id`, `education_id`, `lesson_id`, `status`, `user_id`) VALUES
(1, 1, NULL, NULL, NULL, 3),
(2, 1, NULL, NULL, NULL, 4),
(3, 1, NULL, NULL, NULL, 5),
(4, 1, NULL, NULL, NULL, 6),
(5, 1, NULL, NULL, NULL, 7),
(6, 1, NULL, NULL, NULL, 8),
(7, 1, NULL, NULL, NULL, 9);
