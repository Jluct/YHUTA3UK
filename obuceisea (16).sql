...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Мар 18 2016 г., 17:08
...
(2, 1, 1, 'Табличная вёрстка', NULL, 'Табличная вёрстка описание', 1),
...
(20, 7, 'Блокировка', '#', 0, 1),
(21, 7, 'Удалить', '#', 0, 1),
(22, 7, 'Редактировать', '?ctrl=teacher&action=EditWisdom&education=', 0, 1),
(23, 8, 'Редактировать', '?ctrl=teacher&action=EditWisdom&lesson=', 0, 1),
