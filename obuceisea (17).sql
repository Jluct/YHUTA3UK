...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Мар 23 2016 г., 10:30
...
(2, 1, 1, 'Блочная вёрстка', NULL, 'ВАЫПФУ', 1),
...
(14, 'ывпу', '\\выап\\в', '<p>\\а\\выавыавыавыавыавыавы</p>\r\n', 5, 0, 2, NULL);
...
(4, 2, 'Комплексы курсов', '?ctrl=wisdom&action=WisdomType&type=1&page=1', 0, 1),
...
(26, 9, 'Редактировать', '?ctrl=teacher&action=EditLesson&lesson=', 0, 1),
(27, 9, 'Удалить', '#', 0, 1);
