...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Мар 02 2016 г., 18:27
...
INSERT INTO `lesson` (`id`, `name`, `description`, `text`, `block`, `education_id`) VALUES
(1, 'Таблицы', 'Таблицы описание', 'Таблицы описание', 1, 2),
(2, 'Вёрстка таблиц', 'Вёрстка таблиц описание', 'Вёрстка таблиц описание', 1, 2),
(3, 'Блоки', 'Блоки описание', 'Блоки описание', 1, 3),
(4, 'Вёрстка блоков', 'Вёрстка блоков описание', 'Вёрстка блоков описание', 1, 3),
(5, 'Понятие алгоритм', 'Понятие алгоритм описание', 'Понятие алгоритм описание', 1, 5),
(6, 'Цикл как элемент алгоритма', 'Цикл как элемент алгоритма описание', 'Цикл как элемент алгоритма описание', 1, 5),
(7, 'Построение веб-страницы', 'Построение веб-страницы описание', 'Построение веб-страницы описание', 1, 6),
(8, 'DOM и его особенности', 'DOM и его особенности описание', 'DOM и его особенности описание', 1, 6);
